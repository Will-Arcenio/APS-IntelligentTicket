<?php 
    ...
    $sqlInstruct = "SELECT * FROM categorias where id = 2";
    ...
    <div class="category-eventos">
        <div class="evento-grid col-md-12 hide-addtolinks hide-addtocart">
            <div class="container">
                <div class="row">
                    <?php
                         $sqlInstructEvent = "SELECT eventos.*, categorias.nome AS categoria FROM eventos INNER JOIN categorias ON (eventos.id_categoria = categorias.id) WHERE eventos.id_categoria = '2'";
